class Game {
  ...
  play() { // chamada dentro da função draw!
    ...
    if (allPlayers !== undefined) {  
      ...
      this.showLife(); // barra de vida para cada player
      this.showFuelBar();
  ...
  showLeaderboard() { // fazendo com que o placar apareça na tela
    var leader1, leader2;
    var players = Object.values(allPlayers); // retorna uma matriz com os condutores
    if (
